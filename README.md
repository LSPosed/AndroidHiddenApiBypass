...
- Safe: no `Unsafe`.
- Unreliable: can be blocked as easily as meta-reflection and cannot be used to access core platform api if core platform api restriction is enabled in future Android releases.
